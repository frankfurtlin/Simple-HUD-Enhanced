...
public class StatusEffectBarRenderer {
    ...
    public static void render(DrawContext drawContext, StatusEffectInstance effect, int x, int y,
                              int width, int height, SimpleHudEnhancedConfig config) {
    ...
    private static void drawVerticalBar(int x, int y, int startX, int startY, int endY, float progress,
                                        DrawContext drawContext, StatusEffectInstance effect) {
    ...
    private static void drawHorizontalBar(int x, int y, int startX, int endX, int startY,float progress,
                                          DrawContext drawContext, StatusEffectInstance effect) {
